...
def train_val_data_process():
    ...
    train_dataloader = Data.DataLoader(dataset=train_data, batch_size=16, shuffle=True, num_workers=10)
    val_dataloader = Data.DataLoader(dataset=val_data, batch_size=16, shuffle=True, num_workers=10)
